  ...
  return (
    ...
    >
      ...
      <div>
        ...
        />
        <label htmlFor="time">{i18n[language].insertForm.timeLabel}</label>
        <input
          type="time"
          name="time"
          value={time}
      ...
      <div>
        <label htmlFor="type">{i18n[language].insertForm.serving}</label>
        <div>
          <input
            name="type"
            value={type}
      ...
      <div>
        <label htmlFor="amount">{i18n[language].insertForm.amount}</label>
      </div>
      <div>
        <input
          type="number"
      ...
      <div>
        ...
        <Error visible={showError} text={i18n[language].insertForm.error} />
      </div>
    </form>
  );
};
