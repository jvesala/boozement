...
export const PasswordForm = () => {
  ...
  return (
    <div className="PasswordForm">
      ...
      >
        <div>
          <label htmlFor="password">{i18n[language].password.current}</label>
        </div>
        <div>
          <input
            type="password"
        ...
        <div>
          <label htmlFor="password">{i18n[language].password.new}</label>
        </div>
        <div>
          <input
            type="password"
        ...
        {passwordResult ? (
          <div className="result">{i18n[language].password.result}</div>
        ) : (
          ''
        )}

        <Error visible={passwordError} text={i18n[language].password.error} />
      </form>
    </div>
  );
};
