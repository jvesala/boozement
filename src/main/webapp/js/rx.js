...
(function() {
    ...
    if (typeof ProvideCustomRxRootObject == "undefined")b = c.Rx = {}; else b = ProvideCustomRxRootObject();
    var e = function() {
    };
    var f = function() {
    ...
    var m = b.RefCountDisposable = function(r0) {
        ...
        this.GetDisposable = function() {
            if (this.b)return j; else return new l(this);
        };
    };
    var n = b.CompositeDisposable = function() {
        ...
        this.Add = function(u0) {
            if (!t0)r0.Add(u0); else u0.Dispose();
        };
            ...
            x0 = function() {
                u0(function() {
                    ...
                    A0 = v0.Schedule(function() {
                        x0();
                        if (y0)w0.Remove(A0); else z0 = true;
                    });
                    if (!z0) {
                        w0.Add(A0);
                        y0 = true;
            ...
            y0 = function() {
                u0(function(z0) {
                    ...
                    C0 = w0.ScheduleWithTime(function() {
                        y0();
                        if (A0)x0.Remove(C0); else B0 = true;
                    }, z0);
                    if (!B0) {
                        x0.Add(C0);
                        A0 = true;
    ...
    D.prototype = {Subscribe:function(r0, s0, t0) {
        var u0;
        if (arguments.length == 0 || arguments.length > 1 || typeof r0 == "function")u0 = new B(r0, s0, t0); else u0 = r0;
        return this.x(u0);
    },x:function(r0) {
        var s0 = false;
        var t0 = new o();
        ...
        var u0;
        if (arguments.length == 0 || arguments.length > 1 || typeof r0 == "function")u0 = new B(r0, s0 !== a ? s0 : e, t0); else u0 = r0;
        var v0 = this;
        ...
        return E(function(t0) {
            ...
            return s0.Subscribe(new B(function(v0) {
                if (u0) {
                    ...
                    if (u0)t0.OnNext(v0); else t0.OnCompleted();
                }
            }, function(v0) {
                t0.OnError(v0);
            }, function() {
        ...
        return E(function(u0) {
            ...
            var y0 = t0.Materialize().Timestamp().Subscribe(function(z0) {
                ...
                v0.push({Timestamp:s0.Now() + r0,Value:z0.Value});
                if (!w0) {
        ...
        return E(function(v0) {
            ...
            z0.Add(u0.Subscribe(function(C0) {
                w0.Add({Value:C0,Timestamp:t0.Now()});
            }, A0, B0));
        ...
        return E(function(t0) {
            ...
            var w0 = s0.ScheduleRecursive(function(x0) {
                if (v0 < r0.length) {
                    var y0 = r0[v0];
                    v0++;
                    u0.Replace(y0.Subscribe(function(z0) {
                        t0.OnNext(z0);
                    }, function(z0) {
                        t0.OnError(z0);
                    }, x0));
        ...
        return E(function(t0) {
            ...
            var w0 = s0.ScheduleRecursive(function(x0) {
                ...
                u0.Replace(y0.Subscribe(function(z0) {
                    ...
                    if (v0 < r0.length)x0(); else t0.OnError(z0);
                }, function() {
                    t0.OnCompleted();
                }));
            });
    ...
    var U = D.GenerateWithTime = function(r0, s0, t0, u0, v0, w0) {
        ...
        return new E(function(x0) {
            ...
            return w0.ScheduleRecursiveWithTime(function(D0) {
                ...
                if (A0)D0(C0); else x0.OnCompleted();
            }, 0);
        });
    };
    ...
    var h0 = b.Notification = function(r0, s0) {
        ...
        this.Accept = function(t0) {
            switch (this.Kind) {case "N":t0.OnNext(this.Value);break;case "E":t0.OnError(this.Value);break;case "C":t0.OnCompleted();break;
            }
            return j;
        };
        this.w = function(t0) {
    ...
    var m0 = b.ReplaySubject = function(r0, s0, t0) {
        ...
        var y0 = function(z0, A0) {
            v0.Add({Value:new h0(z0, A0),Timestamp:t0.Now()});
        };
        this.A = function() {
